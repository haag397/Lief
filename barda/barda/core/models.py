...
class AdminData(models.Model):
    ...
    rule_id = models.ForeignKey(Rules, on_delete=models.CASCADE, null=True)
...
class ApplicationData(models.Model):
    """
    Defines the attributes of applications
    """
    ...
    REQUIRED_FIELDS = ["app_name", "description"]
...
class UserData(models.Model):
    ...
    created_by_id = models.ForeignKey(AdminData, on_delete=models.CASCADE, null=True)
    applications = models.ManyToManyField(ApplicationData, related_name="books")
